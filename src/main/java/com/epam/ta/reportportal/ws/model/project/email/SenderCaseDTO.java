...
public class SenderCaseDTO implements Serializable {
	...
	@In(allowedValues = { "always", "failed", "untested", "running", "toInvestigate", "more10", "more20", "more50" })
	@ApiModelProperty(allowableValues = "ALWAYS, FAILED, UNTESTED, RUNNING, MORE_10, MORE_20, MORE_50")

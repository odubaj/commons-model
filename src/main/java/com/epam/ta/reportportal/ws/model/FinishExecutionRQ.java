...
public class FinishExecutionRQ {
	...
	@In(allowedValues = { "passed", "failed", "stopped", "skipped", "interrupted", "cancelled", "untested", "running", "info", "warn" })
	@ApiModelProperty(allowableValues = "PASSED, FAILED, STOPPED, SKIPPED, INTERRUPTED, CANCELLED, UNTESTED, RUNNING, INFO, WARN")
